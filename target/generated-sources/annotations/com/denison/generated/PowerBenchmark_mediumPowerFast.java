...
public final class PowerBenchmark_mediumPowerFast {
    ...
    public Collection<? extends Result> mediumPowerFast_Throughput(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_powerbenchmark0_0.mediumPowerFast());
            }

            RawResults res = new RawResults(15L);
            mediumPowerFast_Throughput_measurementLoop(control, res, l_powerbenchmark0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                f_powerbenchmark0_0 = null;
                f_blackhole1_1 = null;
            }
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MICROSECONDS;
            results.add(new ThroughputResult(ResultRole.PRIMARY, "mediumPowerFast", res.getOperations(), res.getTime(), tu));
            return results;
        } else
    ...
    public void mediumPowerFast_Throughput_measurementLoop(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> mediumPowerFast_AverageTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            RawResults res = new RawResults(15L);
            mediumPowerFast_AverageTime_measurementLoop(control, res, l_powerbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_powerbenchmark0_0.mediumPowerFast());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MICROSECONDS;
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "mediumPowerFast", res.getOperations(), res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void mediumPowerFast_AverageTime_measurementLoop(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> mediumPowerFast_SampleTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            mediumPowerFast_SampleTime_measurementLoop(control, buffer, targetSamples, l_powerbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_powerbenchmark0_0.mediumPowerFast());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MICROSECONDS;
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "mediumPowerFast", buffer, tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void mediumPowerFast_SampleTime_measurementLoop(InfraControl control, SampleBuffer buffer, int targetSamples, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public Collection<? extends Result> mediumPowerFast_SingleShotTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            RawResults res = new RawResults(15L);
            mediumPowerFast_SingleShotTime_measurementStub(control, res, l_powerbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MICROSECONDS;
            results.add(new SingleShotResult(ResultRole.PRIMARY, "mediumPowerFast", res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void mediumPowerFast_SingleShotTime_measurementStub(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
    ...
    PowerBenchmark_1_jmh f_powerbenchmark0_0;
    
    PowerBenchmark_1_jmh _jmh_tryInit_f_powerbenchmark0_0(InfraControl control) throws Throwable {
        if (f_powerbenchmark0_0 == null) {
            PowerBenchmark_1_jmh val = new PowerBenchmark_1_jmh();
            val.readyTrial = true;
            f_powerbenchmark0_0 = val;
        }
        return f_powerbenchmark0_0;
    }
    ...
    static class PowerBenchmark_1_jmh_B1 extends com.denison.PowerBenchmark {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class PowerBenchmark_1_jmh_B2 extends PowerBenchmark_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(PowerBenchmark_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(PowerBenchmark_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(PowerBenchmark_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(PowerBenchmark_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(PowerBenchmark_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(PowerBenchmark_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class PowerBenchmark_1_jmh_B3 extends PowerBenchmark_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class PowerBenchmark_1_jmh extends PowerBenchmark_1_jmh_B3 {
    }
