...
public final class PowerBenchmark_powerFast {
    ...
    public Collection<? extends Result> powerFast_Throughput(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_powerbenchmark0_0.powerFast());
            }

            RawResults res = new RawResults(30L);
            powerFast_Throughput_measurementLoop(control, res, l_powerbenchmark0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "powerFast", res.getOperations(), res.getTime(), tu));
            return results;
        } else
    ...
    public void powerFast_Throughput_measurementLoop(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> powerFast_AverageTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            RawResults res = new RawResults(30L);
            powerFast_AverageTime_measurementLoop(control, res, l_powerbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_powerbenchmark0_0.powerFast());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "powerFast", res.getOperations(), res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void powerFast_AverageTime_measurementLoop(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> powerFast_SampleTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            powerFast_SampleTime_measurementLoop(control, buffer, targetSamples, l_powerbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_powerbenchmark0_0.powerFast());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "powerFast", buffer, tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void powerFast_SampleTime_measurementLoop(InfraControl control, SampleBuffer buffer, int targetSamples, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public Collection<? extends Result> powerFast_SingleShotTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            RawResults res = new RawResults(30L);
            powerFast_SingleShotTime_measurementStub(control, res, l_powerbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SingleShotResult(ResultRole.PRIMARY, "powerFast", res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void powerFast_SingleShotTime_measurementStub(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
