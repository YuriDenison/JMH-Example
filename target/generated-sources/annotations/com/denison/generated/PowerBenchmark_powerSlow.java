...
public final class PowerBenchmark_powerSlow {
    ...
    public Collection<? extends Result> powerSlow_Throughput(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_powerbenchmark0_0.powerSlow());
            }

            RawResults res = new RawResults(30L);
            powerSlow_Throughput_measurementLoop(control, res, l_powerbenchmark0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "powerSlow", res.getOperations(), res.getTime(), tu));
            return results;
        } else
    ...
    public void powerSlow_Throughput_measurementLoop(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> powerSlow_AverageTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            RawResults res = new RawResults(30L);
            powerSlow_AverageTime_measurementLoop(control, res, l_powerbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_powerbenchmark0_0.powerSlow());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "powerSlow", res.getOperations(), res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void powerSlow_AverageTime_measurementLoop(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> powerSlow_SampleTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            powerSlow_SampleTime_measurementLoop(control, buffer, targetSamples, l_powerbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_powerbenchmark0_0.powerSlow());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "powerSlow", buffer, tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void powerSlow_SampleTime_measurementLoop(InfraControl control, SampleBuffer buffer, int targetSamples, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public Collection<? extends Result> powerSlow_SingleShotTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            PowerBenchmark_1_jmh l_powerbenchmark0_0 = _jmh_tryInit_f_powerbenchmark0_0(control);
            ...
            RawResults res = new RawResults(30L);
            powerSlow_SingleShotTime_measurementStub(control, res, l_powerbenchmark0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SingleShotResult(ResultRole.PRIMARY, "powerSlow", res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void powerSlow_SingleShotTime_measurementStub(InfraControl control, RawResults result, PowerBenchmark_1_jmh l_powerbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
